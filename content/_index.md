...
>}}
{{< card
  link="blog/aws/aws-ssm-ec2-rds-elasticacahe-msk-scp"
...
>}}
{{< card
  link="blog/gcp/gcp-lb-introduce"
  title="GCP Load Balancer 介紹"
  subtitle="發布日期：2025-05-26"
  image="/gcp/gcp-lb-introduce/cover.webp"
>}}
{{< card
  link="blog/kubernetes/k8s-open-region-how-to-reduce-cross-zone-costs"
...
>}}
{{< card
  link="blog/aws/aws-ssm-macos-ec2-vnc-gui"
...
>}}
{{< card
  link="blog/nginx/proxy-set-header"
  title="Nginx Proxy Set Header 注意事項"
  subtitle="發布日期：2024-08-06"
  image="/nginx/proxy-set-header/cover.webp"
>}}
{{< card
  link="blog/agile/jira-to-google-chat"
  title="串接 Jira 工單自動化通知到 Google Chat"
  subtitle="發布日期：2024-08-06"
  image="/agile/jira-to-google-chat/cover.webp"
>}}
{{< card
  link="blog/conference-or-lecture/20240529-devops-introduce"
...
>}}
{{< card
  link="blog/kubernetes/k8s-statefulset-podmanagementpolicy"
...
>}}
{{< card
  link="blog/nginx/nginx-upstream-set-host-header"
  title="想使用 Nginx Upstream Proxy 到外部服務，並帶入對應的 header 該怎麼做？"
  subtitle="發布日期：2023-10-16"
  image="/nginx/nginx-upstream-set-host-header/cover.webp"
>}}
{{< card
  link="blog/nginx/soketi-log-502-error"
  title="Soketi WebSocket Server LOG 不定時出現 502 error 以及 connect() failed (111: Connection refused)"
  subtitle="發布日期：2023-09-20"
  image="/nginx/soketi-log-502-error/cover.webp"
>}}
{{< card
  link="blog/kubernetes/pod-veth-name-provided-eth0-already-exists"
...
>}}
{{< card
  link="blog/opentelemetry/opentelemetry-ingress-nginx-controller"
  title="如何透過 OpenTelemetry 來收集 Ingress Nginx Controller 的 Metrics 與 Traces 並送到 Datadog 上"
  subtitle="發布日期：2023-09-13"
  image="/opentelemetry/opentelemetry-ingress-nginx-controller/cover.webp"
>}}
{{< card
  link="blog/opentelemetry/opentelemetry-observability"
  title="什麼是 Opentelemetry？可觀測性 (Observability) 又是什麼？"
  subtitle="發布日期：2023-09-06"
  image="/opentelemetry/opentelemetry-observability/cover.webp"
>}}
{{< card
  link="blog/gcp/gcp-log-reduce-cloud-logging-api"
  title="如何過濾 GCP LOG，減少 Cloud Logging API 的花費"
  subtitle="發布日期：2023-07-30"
  image="/gcp/gcp-log-reduce-cloud-logging-api/cover.webp"
>}}
{{< card
  link="blog/terraform/terragrunt"
  title="如何導入 Terragrunt，Terragrunt 好處是什麼？"
  subtitle="發布日期：2023-06-21"
  image="/terraform/terragrunt/cover.webp"
>}}
{{< card
  link="blog/terraform/terraform-module"
  title="如何將 Terraform 改寫成 module ?"
  subtitle="發布日期：2023-06-16"
  image="/terraform/terraform-module/cover.webp"
>}}
{{< card
  link="blog/terraform/terraform-tfstate"
  title="Terraform 如何多人共同開發 (將 tfstate 存在後端)"
  subtitle="發布日期：2023-05-29"
  image="/terraform/terraform-tfstate/cover.webp"
>}}
{{< card
  link="blog/other/bookstack"
  title="Bookstack 開源知識庫筆記平台安裝 (K8s + docker)"
  subtitle="發布日期：2023-04-07"
  image="/other/bookstack/cover.webp"
>}}
{{< card
  link="blog/gcp/gke-cronjob-not-working"
...
>}}
{{< card
  link="blog/git-or-cicd/gitlab-package-registry-to-gcs"
  title="如何啟用 GitLab 的 Package Registry 以及將儲存位置從伺服器改到 GCS 上"
  subtitle="發布日期：2022-12-29"
  image="/git-or-cicd/gitlab-package-registry-to-gcs/cover.webp"
>}}
{{< card
  link="blog/rd/fluentd-server-show-fluent-plugin-elasticsearch-error400"
  title="Fluentd-Server 出現 Fluent::Plugin::Elasticsearch Error 400 - Rejected by Elasticsearch 錯誤解決"
  subtitle="發布日期：2022-12-12"
  image="/rd/fluentd-server-show-fluent-plugin-elasticsearch-error400/cover.webp"
>}}
{{< card
  link="blog/rd/kibana-create-index-forbidden"
  title="Kibana 新增 index 索引時一直轉圈圈以及顯示 HTTP 403 Forbidden"
  subtitle="發布日期：2022-12-08"
  image="/rd/kibana-create-index-forbidden/cover.webp"
>}}
{{< card
  link="blog/terraform/terraform-gke"
  title="使用 Terraform 建立 Google Kubernetes Engine"
  subtitle="發布日期：2022-11-29"
  image="/terraform/terraform-gke/cover.webp"
>}}
{{< card
  link="blog/terraform/terraform-gce"
  title="使用 Terraform 建立 Google Compute Engine"
  subtitle="發布日期：2022-11-28"
  image="/terraform/terraform-gce/cover.webp"
>}}
{{< card
  link="blog/terraform/terraform"
  title="什麼是 IaC ? Terraform 又是什麼？"
  subtitle="發布日期：2022-09-26"
  image="/terraform/terraform/cover.webp"
>}}
{{< card
  link="blog/other/snyk"
  title="找出程式碼、開源套件、容器的安全漏洞工具 - Snyk"
  subtitle="發布日期：2022-09-20"
  image="/other/snyk/cover.webp"
>}}
{{< card
  link="blog/kubernetes/gcp-k8s-hpa-php-custom-metrics"
...
>}}
{{< card
  link="blog/git-or-cicd/git-merge-multiple-commit"
  title="如何合併多個 commit，且推到遠端呢？"
  subtitle="發布日期：2022-06-21"
  image="/git-or-cicd/git-merge-multiple-commit/cover.webp"
>}}
{{< card
  link="blog/other/linux-command"
  title="Linux 常用指令"
  subtitle="發布日期：2022-06-17"
  image="/other/linux-command/cover.webp"
>}}
{{< card
  link="blog/other/linux-clear-swap"
  title="清除 Linux 機器上的 Swap (Buff、Cache、Swap 比較)"
  subtitle="發布日期：2022-06-06"
  image="/other/linux-clear-swap/cover.webp"
>}}
{{< card
  link="blog/kubernetes/k8s-plain"
  title="用大型社區來介紹 Kubernetes 元件"
  subtitle="發布日期：2022-06-02"
  image="/kubernetes/k8s-plain/cover.webp"
>}}
{{< card
  link="blog/git-or-cicd/laravel-gitlab-cicd-heroku"
  title="部署 Laravel 於 Heroku 搭配 GitLab CI/CD"
  subtitle="發布日期：2022-05-26"
  image="/git-or-cicd/laravel-gitlab-cicd-heroku/cover.webp"
>}}
{{< card
  link="blog/git-or-cicd/gitlab-cicd"
  title="如何從頭打造專屬的 GitLab CI/CD"
  subtitle="發布日期：2022-05-26"
  image="/git-or-cicd/gitlab-cicd/cover.webp"
>}}
{{< card
  link="blog/docker/prometheus-grafana-docker"
  title="使用 Prometheus 和 Grafana 打造監控預警系統 (Docker 篇)"
  subtitle="發布日期：2022-05-18"
  image="/docker/prometheus-grafana-docker/cover.webp"
>}}
{{< card
  link="blog/git-or-cicd/ansible"
  title="Ansible 介紹與實作 (Inventory、Playbooks、Module、Template、Handlers)"
  subtitle="發布日期：2022-05-16"
  image="/git-or-cicd/ansible/cover.webp"
>}}
{{< card
  link="blog/git-or-cicd/jenkins-github-tg-bot"
  title="使用 Jenkins 設定 GitHub 觸發程序並通知 Telegram Bot"
  subtitle="發布日期：2022-05-16"
  image="/git-or-cicd/jenkins-github-tg-bot/cover.webp"
>}}
{{< card
  link="blog/git-or-cicd/jenkins-ansible-it-cicd"
  title="Jenkins 及 Ansible IT 自動化 CI/CD 介紹"
  subtitle="發布日期：2022-05-11"
  image="/git-or-cicd/jenkins-ansible-it-cicd/cover.webp"
>}}
{{< card
  link="blog/kubernetes/k8s-efk"
...
>}}
{{< card
  link="blog/kubernetes/k8s-advanced"
...
>}}
{{< card
  link="blog/kubernetes/k8s"
  title="Kubernetes (K8s) 介紹 - 基本"
  subtitle="發布日期：2022-04-28"
  image="/kubernetes/k8s/cover.webp"
>}}
{{< card
  link="blog/rd/redis-sentinel-docker-compose-haproxy-efk"
  title="用 EFK 收集容器日誌 (HAProxy、Redis Sentinel、Docker-compose)"
  subtitle="發布日期：2022-04-22"
  image="/rd/redis-sentinel-docker-compose-haproxy-efk/cover.webp"
>}}
{{< card
  link="blog/redis/redis-sentinel-docker-compose-haproxy"
  title="用 HAProxy 對 Redis 做負載平衡 (Redis Sentinel、Docker-compose)"
  subtitle="發布日期：2022-04-22"
  image="/redis/redis-sentinel-docker-compose-haproxy/cover.webp"
>}}
{{< card
  link="blog/redis/redis-sentinel-docker-compose"
  title="Redis 哨兵模式 (Sentinel) 搭配 Docker-compose 實作"
  subtitle="發布日期：2022-04-19"
  image="/redis/redis-sentinel-docker-compose/cover.webp"
>}}
{{< card
  link="blog/git-or-cicd/git-introduce"
  title="Git 介紹"
  subtitle="發布日期：2022-04-15"
...
>}}
{{< card
  link="blog/redis/redis-introduce"
  title="Redis 介紹"
  subtitle="發布日期：2022-03-08"
  image="/redis/redis-introduce/cover.webp"
>}}
{{< card
  link="blog/php-laravel/laravel-advanced"
  title="Laravel 進階 (內建會員系統、驗證 RESTful API 是否登入、使用 Repository 設計模式)"
  subtitle="發布日期：2022-03-08"
  image="/php-laravel/laravel-advanced/cover.webp"
>}}
{{< card
  link="blog/php-laravel/laravel"
  title="Laravel 介紹 (使用 Laravel 從零到有開發出一個留言板功能並搭配 RESTful API 來實現 CRUD)"
  subtitle="發布日期：2022-03-02"
  image="/php-laravel/laravel/cover.webp"
>}}
{{< card
  link="blog/php-laravel/nginx-php-restful-api"
  title="如何在 Nginx 下實作第一個 PHP 留言板 RESTful API"
  subtitle="發布日期：2022-02-24"
  image="/php-laravel/nginx-php-restful-api/cover.webp"
>}}
{{< card
  link="blog/php-laravel/php-introduce"
  title="PHP 介紹"
  subtitle="發布日期：2022-02-22"
  image="/php-laravel/php-introduce/cover.webp"
>}}
{{< /hextra/feature-grid >}}
